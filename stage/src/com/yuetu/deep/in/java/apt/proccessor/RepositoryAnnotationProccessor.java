...
@SupportedAnnotationTypes("com.yuetu.deep.in.java.apt.reflection.Repository")
@SupportedSourceVersion(SourceVersion.RELEASE_8)
public class RepositoryAnnotationProccessor extends AbstractProcessor {
    public static final String REPOSITORY_ANNOTATION_CLASS_NAME = "com.yuetu.deep.in.java.apt.reflection.CrudRepository";

    private static final String CRUD_REPOSITORY_INTERFACE_CLASS_NAME = "com.yuetu.deep.in.java.apt.reflection.CrudRepository";
